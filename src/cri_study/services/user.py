...
from repositories.exam import ExamRepository, get_exam_repository
...
class UserService:
    ...
    def delete_user(self, user_id: int, current_user_id: int) -> str | None:
        ...
        # 受験履歴を先に削除
        self.exam_repository.delete_by_user_id(user_id)
...
def get_user_service(
    ...
    return UserService(user_repository, organization_repository, exam_repository, auth_service)
